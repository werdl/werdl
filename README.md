## Low Level and Unix Developer

## About
- Unix enthusiast
- Extensive experience with Unices including *BSD, Linux and MacOS X
- I use Void Linux and MacOS on my personal systems
- Server-wise I often use Debian and Alpine
- Prior work on low level stuff (kernels etc) and networking, using chiefly Rust and C
- UK high school student
- I also manage a technical theatre group
- Basic web stuff
- Reduced activity while I go through external exams
...
- 👥 Email me at: [`werdl_@outlook.com`](mailto:werdl_@outlook.com) - I would love to connect!
### Languages
[![My Skills](https://skillicons.dev/icons?i=rust,c,py,go,bash&theme=dark)](https://skillicons.dev)
### Tools
[![My Skills](https://skillicons.dev/icons?i=neovim,vim,svg,git,github&theme=dark)](https://skillicons.dev)
### OSes
