...
-->
[![My Skills](https://skillicons.dev/icons?i=c,cpp,arduino,linux,bash,powershell,vim,neovim,vscode,php,flask,python&theme=dark&perline=6)](https://skillicons.dev)
